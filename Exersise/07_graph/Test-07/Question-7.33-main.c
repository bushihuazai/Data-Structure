...
#include "../../../Algorithms/06_tree_binaryTree/07 ChildSiblingTree/ChildSiblingTree.c"//**06_tree_binaryTree**//
...
void InitEdgeSet_7_33(EdgeSetType EdgeSet[], ALGraph G);        //Initial边集
...
void InitMFSet_7_33(MFSet S[], ALGraph G);                        //Initial并查集
